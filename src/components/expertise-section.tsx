...
const expertiseData = [
    {
      ...
      images: ["/images/projects/chappe sèche.JPG", "/images/projects/chappe sèche2.JPG"],
    },
    {
      ...
      images: ["/images/projects/plafond acoustique terminé.JPG", "/images/projects/cloisons mod.JPG"],
    },
    {
...
export function ExpertiseSection() {
  return (
    <section id="expertise" className="py-16 scroll-mt-20 bg-gray-50">
